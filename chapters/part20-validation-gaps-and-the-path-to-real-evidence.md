...
| 4 | Platform, SOC management | Current ingest vs. workload (SVC) pricing mechanics; license-usage-report threshold behavior (flagged unverified in Part 4's own `What Would Change My Mind`) | A real billing relationship's `Settings > Licensing > Usage Report`, observed across a rolling window |
